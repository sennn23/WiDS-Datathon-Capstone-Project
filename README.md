...
Average behavioural differences by sex.

Differences in the association between predictors and ADHD by sex.
...
Perform preprocessing using training data only.

Apply Fisher's z transformation to connectivity measures.

Rank connectivity edges within the training fold.

Retain the top 50 candidate connectivity edges.

Train Logistic Regression and LightGBM models.

Evaluate predictions on the held-out fold.
...
Somatomotor A ↔ Dorsal Attention B
