...
│
├── figures/
│   ├── sex_stratified_pipeline.png
│   ├── stable_edges.png
│   └── interaction_forest_plot.png
│
├── tables/
...
│
└── scripts/
    └── sex_stratified_analysis.R
```

> **Note:** Replace the figure placeholders with the exported figures from the final analysis. Keep the detailed explanation here, while the scripts, complete interaction table, and underlying figures provide the reproducible analysis record.
